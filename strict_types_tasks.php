...
echo calculateTax(100, 0.2) . PHP_EOL;
echo calculateTax(50, 0.15) . PHP_EOL;
echo calculateTax(99.99, 0.05) . PHP_EOL;
...
echo formatValue(100) . PHP_EOL;
echo formatValue(99.99) . PHP_EOL;
echo formatValue("hello") . PHP_EOL;
